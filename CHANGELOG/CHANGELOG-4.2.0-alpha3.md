...
```shell
    curl -sfL  https://raw.githubusercontent.com/nebstudio/sealos/v4.2.0-alpha3/scripts/install.sh \
    | sh -s v4.2.0-alpha3 nebstudio/sealos
```
...
**Full Changelog**: https://github.com/nebstudio/sealos/compare/v4.2.0-alpha2...v4.2.0-alpha3
